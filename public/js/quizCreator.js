...
function updateDatabase(){
    ...
    for(var i = 1; i <= questionNum; i++){
        if(questionType[i] == "identification"){
            var question = document.getElementById('q' + i).value;
            var correct = document.getElementById('correct' + i).value;
            var answers = [];
            questions.push({"question": question, "correct": correct, "type": "identification"});
        } else{
            var question = document.getElementById('q' + i).value;
            ...
            questions.push({"question": question, "answers": answers, "correct": correct, "type": "multiple"});
        }
    }
...
function addQuestion(){
    questionNum += 1;
    questionType[questionNum] = "multiple";
...
function addIdentification(){
    questionNum += 1;
    questionType[questionNum] = "identification";
...
socket.on('startGameFromCreator', function(){
